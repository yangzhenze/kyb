<template>
  <div class="app-container">
    ...
    <table-model ref="tableModel" :page-fun="getPage" :control-column="true" :del-fun="deleteData" :columns="columns"/>
...
import { getList, addMsg, getMsg, delMsg } from '@/api/kyb/msg'
    ...
    createData(formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          addMsg(objectToFormData(this.dataForm)).then(response => {
            debugger
            if (response.code === 0) {
